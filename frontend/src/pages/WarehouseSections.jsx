...
// import { sectionAPI, warehouseAPI, itemAPI, productAPI, subProductAPI, supplierAPI } from '../services/api';
...
//     try {
//       setLoading(true);
//       const [sectionsResponse, warehousesResponse, itemsResponse, productsResponse, subProductsResponse, suppliersResponse] = await Promise.all([
